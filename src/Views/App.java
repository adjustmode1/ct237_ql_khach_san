...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Đồ Án: Quản Lý Khách Sạn");

        jLabel3.setText("GVHD: Trần Công Án");

        jLabel4.setText("SVTH: Bùi Công Minh");

        jLabel5.setText("MSSV: B1809261");

        jLabel6.setText("Môn: Nguyên Lý Hệ Quản Trị CSDL");
